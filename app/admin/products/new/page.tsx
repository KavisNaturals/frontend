    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-end space-x-4">
          <button className="px-12 py-3 bg-[#003F62] text-white font-semibold rounded-lg hover:bg-[#003F62]/90">
            ADD
          </button>
          <Link
            href="/admin/products"
            className="px-12 py-3 border-2 border-gray-900 text-gray-900 font-semibold rounded-lg hover:bg-gray-50"
          >
            CANCEL
          </Link>
        </div>
